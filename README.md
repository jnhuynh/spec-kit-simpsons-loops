...
When using the pipeline, quality gates are hardcoded in `pipeline.sh` (see the `QUALITY_GATES` variable near the top). Update this variable with your project's actual quality gate commands before running the pipeline.
